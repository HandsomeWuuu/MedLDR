...
log_file=./logs_gen/gen_mimic/all/sft/distill_llama_8b/sft_all_llama_8b_out.log
...
accelerate launch --config_file=recipes/accelerate_configs/zero2.yaml src/open_r1/sft_mimic.py \
    --model_name_or_path $base_path/models/DeepSeek-R1-Distill-Llama-8B \
    --train_data_path $base_path/data/split_by_patient_seed1_report_hpi/data/train_data_top_icd_report.json\
    --input_key all \
    --output_dir results/sft/DeepSeek-R1-Distill-Llama-8B_lr5e6/ \
