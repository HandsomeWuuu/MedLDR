...
def main():
    input_file_list = ['/data/h3571902/deep_r1/open_r1/results/grpo/DeepSeek-R1-Distill-Llama-8B-GRPO-mimic-subset-only-acc/back_cp/checkpoint-480-light/50_test_infer_result_batch/result.jsonl']
